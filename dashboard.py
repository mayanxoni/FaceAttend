...
class Ui_form_dashboard(object):
    def setupUi(self, form_dashboard):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("assets/webcam.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label_soacer_bottom = QtWidgets.QLabel(form_dashboard)
        self.label_soacer_bottom.setText("")
        self.label_soacer_bottom.setObjectName("label_soacer_bottom")
        self.verticalLayout.addWidget(self.label_soacer_bottom)
